...
MODULE = ModuleSpec(
    ...
    integrations=(
        IntegrationSpec(
            ...
            description=(
                "Search and browse remote YouTube videos, playlists, channels, and account feeds. "
                "Use when the user requests YouTube, online search, or remote content rather than a local video."
            ),
